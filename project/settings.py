...
# Print emails to the console for testing
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'your_temp_group_email@gmail.com'
# EMAIL_HOST_PASSWORD = 'your_gmail_app_password' # NOT your login password
